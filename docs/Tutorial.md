...
If you are unfamiliar with W3C decentralized identifiers and verifiable credentials, we recommend reading the overviews of chapters 2, 3.1 and 3.2 of the [IOTA Identity guide](https://wiki.iota.org/identity.rs/introduction).
